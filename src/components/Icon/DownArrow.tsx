import { ArrowDirection } from 'shared/constants/enums';

interface DownArrowIconProps {
  direction?: ArrowDirection;
}
const DownArrowIcon: React.FC<DownArrowIconProps> = ({ direction }) => {
  return (
    <svg
      width="16"
      height="16"
      ...
      style={{
        transform:
          direction === ArrowDirection.DOWN ? 'rotate(180deg)' : 'rotate(0deg)',
      }}
    >
      <path
        fillRule="evenodd"
